...
const doNotDelete = "[ 🎧🪶🧘🏻‍♂️ | Goat Bot V2 ]";
/**
* @author NTKhang
	...
	langs: {
		...
		en: {
			help: "╭─────────────⭓"
				...
				+ "\n├─────⭔"
				+ "\n│ 🎧Page [ %2/%3 ]🪶🧘🏻‍♂️"
				+ "\n│ 🎧Currently, the bot has %4 commands that can be used🪶🧘🏻‍♂️"
				+ "\n│ »🎧 Type %5help <page> to view the command list🪶🧘🏻‍♂️"
				+ "\n│ »🎧 Type %5help to view the details of how to use that command🪶🧘🏻‍♂️"
				+ "\n├────────⭔"
				+ "\n│ 🎧%6🪶💙"
				+ "\n╰─────────────⭓",
			help2: "%1├───────⭔"
